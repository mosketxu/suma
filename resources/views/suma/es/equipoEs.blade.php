            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="tarjeta p-3">
                        ...
                        <div class="tarjeta-subtitle">
                            <h5 class="text-muted">Técnico tributario</h5>
                        </div>
                        <div class="tarjeta-body altotarjeta">
                            <p class="text-muted m-0 p-0 mb-1">Máster en Tributación y Asesoría Fiscal.</p>
                            <p class="text-muted m-0 p-0 mb-1">25 años de experiencia en asesoramiento y apoyo en materia fiscal a la pequeña y mediana empresa.
                            </p>
